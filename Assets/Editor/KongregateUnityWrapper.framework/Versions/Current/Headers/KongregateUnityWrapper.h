...
char* _KongregateAPIAnalyticsGetTransactionDetails(char* transactionIdParam, char* resultCodeParam) {
    NSString* transactionId = CreateNSString(transactionIdParam);
    NSString* resultCode = CreateNSString(resultCodeParam);
    return MakeStringCopy([[KongregateAPI.instance.analytics getTransactionDetailsJSON:transactionId withResult:resultCode] UTF8String]);
}

char* _KongregateAPIAnalyticsGetKongProperties() {
    return MakeStringCopy([[KongregateAPI.instance.analytics getKongregatePropertiesJSON] UTF8String]);
}
